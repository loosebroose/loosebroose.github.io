...
## Google Earth
    - What tools does GE pro provide?
        - transect, elevation exaggeration 
        - KML Network Layers
...
- > **Viewing Historical Imagery**
    - In GE users can toggle through historical satellite imagery. This feature can be useful when determining scope of disturbance at sites of interest. Using the polygon for the Red Chris Mine, we can toggle through vintages of imagery to view how the site has changed over time. 
    - In the map menu bar: select the clock icon - a slider then appears, and the user can navigate using the slider to the desired year
        ...
        - NOTE: Consistent satellite imagery may not be available in some locations, and the resolution of the imagery can be poor. Remote mine sites will likely have less valuable satellite imagery overlaying them, whereas sand and gravel sites closer to urban areas will likely have more useful image overlays.
